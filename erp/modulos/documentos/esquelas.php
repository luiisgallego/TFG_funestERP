...
//    file_put_contents (__DIR__."/SOMELOG.log" , print_r($identificadores, TRUE).PHP_EOL, FILE_APPEND );
...
//        file_put_contents (__DIR__."/SOMELOG.log" , print_r($difunto, TRUE).PHP_EOL, FILE_APPEND );
...
//        file_put_contents (__DIR__."/SOMELOG.log" , print_r($servicio, TRUE).PHP_EOL, FILE_APPEND );
