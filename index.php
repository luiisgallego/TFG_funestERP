...
<html>
    <head>
        ...
        <!-- CSS -->
        <link href="./erp/css/estilosLOGIN.css" rel="stylesheet">
    ...
    <body>
        ...
        <div class="container">
            <div class="row main">
                ...
                <div class="main-login main-center">
                    <form id="form-login" class="form-horizontal" method="post" action="./erp/procesa.php">
                        ...
                        <div class="form-group">
                            ...
                            <div class="cols-sm-10">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="username" value="admin" placeholder="Nombre de usuario"/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="cols-sm-10">
                                <div class="input-group">
                                    ...
                                    <input type="password" class="form-control" name="password" value="admin" placeholder="Introduce contraseña"/>
                                </div>
                            </div>
                        </div>
        ...
        <script src="./erp/js/alertify/alertify.min.js"></script>
